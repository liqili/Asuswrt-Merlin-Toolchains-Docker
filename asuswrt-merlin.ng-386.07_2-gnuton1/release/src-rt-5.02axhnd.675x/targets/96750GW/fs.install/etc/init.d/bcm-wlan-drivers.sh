...
load_modules()
{
        ...
        if [ ! -z $CPEROUTER ]; then
            ...
            #Legacy
            dhd_module_params="iface_name=wl dhd_console_ms=0 firmware_path=/rom/etc/wlan/dhd mfg_firmware_path=/rom/etc/wlan/dhd/mfg  dhd_dpc_prio=5"
            wl_module_params="intf_name=wl%d"
        fi
